...
function WebHeader({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    name: "clock",
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Seguir")), onCuenta && /*#__PURE__*/React.createElement(BotonCuenta, {
    onAbrir: onCuenta
...
function ParedCarteles() {
  ...
  React.useEffect(() => {
    ...
    const limpiar = [];
    const listo = () => {
      pared.classList.add('pegada');
      limpiar.push(setTimeout(() => pared.classList.add('lista'), 1200));
    };
    ...
    if (conMouse && !quieto) {
      pared.querySelectorAll('.cartel').forEach(c => {
        ...
        let desde = 0;
        const mover = e => {
          if (!desde) desde = performance.now();else if (performance.now() - desde > 450) c.classList.add('siguiendo');
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    className: "pared animada",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("div", {
    className: "pared-lienzo"
  }, /*#__PURE__*/React.createElement("p", {
    className: "pintura"
  }, "Mextizza"), /*#__PURE__*/React.createElement("div", {
    className: "calco"
  }, "HECHO", /*#__PURE__*/React.createElement("br", null), "A MANO", /*#__PURE__*/React.createElement("br", null), "EN 48H"), CARTELES.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: c.post,
    className: 'cartel' + (c.soloCompu ? ' solo-compu' : ''),
    style: {
      '--x': c.x,
      '--y': c.y,
      '--r': c.r,
    ...
    src: '../../assets/social/posts/post-' + c.post + '.webp',
    alt: "",
    loading: "lazy",
    decoding: "async",
    width: "432",
...
const fechaLegible = iso => {
  ...
  return new Date(Date.UTC(a, m - 1, d, 12)).toLocaleDateString('es-MX', {
    weekday: 'long',
    day: 'numeric',
    month: 'long',
    timeZone: 'UTC'
...
function WebCatering() {
  ...
  const campo = (id, etiqueta, valor, cambiar, props, falla) => /*#__PURE__*/React.createElement("div", {
    className: "campo"
    ...
    "aria-invalid": attempted && !!falla,
    "aria-describedby": attempted && falla ? id + '-error' : undefined
  }, props)), attempted && falla && /*#__PURE__*/React.createElement("p", {
    className: "error",
    id: id + '-error'
  }, falla));
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, /*#__PURE__*/React.createElement(ParedCarteles, null), /*#__PURE__*/React.createElement("div", {
    style: {
      ...webShell.page,
      marginTop: 34
    }
  ...
  }, "Solo necesitamos un espacio al aire libre o ventilado y una superficie firme para montar el horno. Vamos a Atizap\xE1n y la zona norte del Estado de M\xE9xico; si tu fiesta queda m\xE1s lejos, escr\xEDbenos y lo vemos.")), folio ? /*#__PURE__*/React.createElement("div", {
    className: "calcula"
  }, /*#__PURE__*/React.createElement(StatusNote, {
    tone: "ok",
    title: "Fecha solicitada"
  }, "Folio ", folio, ". Te escribimos por WhatsApp para confirmar la disponibilidad y el anticipo.")) : /*#__PURE__*/React.createElement("form", {
    className: "calcula",
    onSubmit: apartar,
    noValidate: true
  }, /*#__PURE__*/React.createElement("h3", null, "\xBFCu\xE1ntos van a ser?"), /*#__PURE__*/React.createElement("span", {
    className: "etiqueta",
    id: "catering-personas"
  }, "Invitados"), /*#__PURE__*/React.createElement("div", {
    className: "contador",
    role: "group",
    "aria-labelledby": "catering-personas"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Una persona menos",
    disabled: n <= c.min,
    onClick: () => setN(v => Math.max(c.min, v - 1))
  }, "\u2212"), /*#__PURE__*/React.createElement("output", {
    "aria-live": "polite"
  }, n), /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Una persona m\xE1s",
    disabled: n >= c.max,
    onClick: () => setN(v => Math.min(c.max, v + 1))
  }, "+"), /*#__PURE__*/React.createElement("small", null, "personas")), /*#__PURE__*/React.createElement("p", {
    className: "nota"
  }, n === c.min ? 'El mínimo es ' + c.min + ': con menos no sale a cuenta montar el horno.' : n === c.max ? '¿Son más de ' + c.max + '? Escríbenos y lo vemos.' : ''), /*#__PURE__*/React.createElement("div", {
    className: "total",
    "aria-live": "polite"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grande"
  }, pesos(total), " ", /*#__PURE__*/React.createElement("small", null, "en total")), /*#__PURE__*/React.createElement("p", null, "Apartas con ", /*#__PURE__*/React.createElement("b", null, pesos(anticipo)), ". Incluye ", c.servicio, " de pizza de toda la carta, ensalada, ", c.incluye, ".")), campo('catering-fecha', 'Fecha', fecha, setFecha, {
    type: 'date',
    min: minimo
  }, fallas.fecha), campo('catering-direccion', 'Dirección de la fiesta', direccion, setDireccion, {
    placeholder: 'Calle, número y colonia',
    autoComplete: 'street-address'
  }, fallas.direccion), campo('catering-nombre', 'Tu nombre', nombre, setNombre, {
    autoComplete: 'name'
  }, fallas.nombre), campo('catering-tel', 'WhatsApp', tel, setTel, {
    type: 'tel',
    inputMode: 'tel',
    placeholder: '10 dígitos',
    autoComplete: 'tel-national'
  }, fallas.tel), error && /*#__PURE__*/React.createElement(StatusNote, {
    tone: "block",
    title: "Algo fall\xF3",
    style: {
      marginTop: 12
    ...
    type: "submit",
    disabled: enviando
  }, enviando ? 'Enviando…' : 'Apartar mi fecha'), /*#__PURE__*/React.createElement("p", {
    className: "pie"
...
const P2X1 = typeof MEXTIZZA_2X1 !== 'undefined' ? MEXTIZZA_2X1 : {
  dia: 3,
  desde: 19,
  nombre: 'Miércoles',
  enMinuscula: 'miércoles'
};
...
const MENSAJE_2X1 = P2X1.nombre + ' de 2x1 · desde las ' + HORA_2X1_TEXTO + ' · pide dos pizzas y la más barata va por nuestra cuenta';
...
function CintaPromo({
  ...
  const grupo = oculto => /*#__PURE__*/React.createElement("div", {
    className: "mx-cinta-grupo",
    ...
    key: i,
    "aria-hidden": oculto || i > 0 ? 'true' : undefined,
    style: {
      display: 'inline-flex',
      alignItems: 'center',
      whiteSpace: 'nowrap',
  ...
  }, "2x1"), MENSAJE_2X1, /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      opacity: 0.5
    }
...
function marcarPromoVista() {
  try {
    window.localStorage.setItem(CLAVE_VISTO, hoyEnCDMX());
  } catch (e) {}
}
function PopupPromo({
  abierto,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      background: 'var(--negro-carbon)',
      borderRadius: 'var(--radius-lg)',
      border: '2px solid var(--dorado-masa)',
  ...
  }, "2x1"), /*#__PURE__*/React.createElement("h2", {
    id: "promo-titulo",
    style: {
      fontFamily: 'var(--font-display)',
      fontSize: 21,
  ...
  }, "Hoy es ", P2X1.enMinuscula, " de 2x1"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 14,
      lineHeight: 1.5,
  ...
  }, "Pide dos pizzas y la m\xE1s barata va por nuestra cuenta."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 12.5,
      lineHeight: 1.5,
...
function PideResena({
  ...
  }, "\xBFC\xF3mo estuvo?"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 13.5,
      lineHeight: 1.5,
  ...
  }, "Si lleg\xF3 como te la imaginabas, cu\xE9ntaselo a Google. Somos una cocina chiquita y as\xED nos encuentran tus vecinos."), /*#__PURE__*/React.createElement("a", {
    href: url,
    target: "_blank",
    rel: "noopener",
    style: {
...
function SeguimientoPedido({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(DireccionRecoger, {
    activo: esPickup,
    style: {
      marginBottom: 16
    }
  ...
  })), orden && orden.estado === "entregada" && typeof PideResena === "function" && /*#__PURE__*/React.createElement(PideResena, {
    style: {
      marginTop: 18
    }
...
function Site() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, modoCaptura && /*#__PURE__*/React.createElement("div", {
    ...
    onAdd: add
  }), /*#__PURE__*/React.createElement(DialogoCuenta, {
    abierto: cuenta,
