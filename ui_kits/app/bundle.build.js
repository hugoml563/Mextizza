...
function CartaApp({
  ...
  const brincar = id => {
    const cont = scroll.current,
      el = cont && cont.querySelector('#' + id);
    if (el) cont.scrollTo({
      top: el.offsetTop - 12,
      behavior: 'smooth'
    });
  ...
  const chip = activo => ({
    ...
    borderRadius: 999,
    border: '2px solid var(--negro-carbon)',
    background: activo ? 'var(--negro-carbon)' : 'transparent',
    color: activo ? 'var(--blanco-hueso)' : 'var(--negro-carbon)',
    fontFamily: 'var(--font-body)',
    fontWeight: 600,
    fontSize: 14,
    letterSpacing: 0.3,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: chip(true),
    onClick: () => brincar('app-carta-pizzas')
  }, "Pizzas"), /*#__PURE__*/React.createElement("button", {
    style: chip(false),
    onClick: () => brincar('app-carta-cierre')
  ...
  }, pizzas.map(it => /*#__PURE__*/React.createElement("div", {
    key: it.id,
    role: "button",
    tabIndex: 0,
    onClick: () => onOpen(it),
  ...
  }, "La del mes"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-display)',
      fontSize: 22,
      lineHeight: 1.1
    }
  }, it.name.replace(/^Pizza /, '')), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 14.5,
      lineHeight: 1.45,
    ...
    onClick: agregar(it)
  }, added === it.id ? 'Agregado' : 'Agregar')))))), /*#__PURE__*/React.createElement("div", {
    id: "app-carta-cierre",
    style: {
      marginTop: 26
    }
  ...
  }, "Para cerrar"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 10
  ...
  }, it.name, it.desc ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 400,
      color: '#5a5650',
      fontSize: 13
    }
  }, it.desc) : null), /*#__PURE__*/React.createElement("span", {
    style: precio
  }, "$", it.price), /*#__PURE__*/React.createElement(Button, {
    size: "sm",
    tone: added === it.id ? 'dark' : 'outline',
...
function AppMenu({
  ...
  return /*#__PURE__*/React.createElement(Phone, null, /*#__PURE__*/React.createElement("div", {
    ...
    position: "bottom",
    height: 3
  })), /*#__PURE__*/React.createElement(CartaApp, {
    onAdd: onAdd,
    onOpen: onOpen,
    added: added
...
function AppCart({
  ...
  const confirmar = async () => {
    ...
    try {
      ...
      onConfirm(r.folio, entrega, {
        ...
        selloPendiente: !!r.selloPendiente
      });
    } catch (err) {
  ...
  return /*#__PURE__*/React.createElement(Phone, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, [promo ? (NOMBRE_PROMO[promo.motivo] || 'Promoción') + ' · −$' + promo.descuento : null, descuentoPickup > 0 ? 'Pasas a recogerlo · −$' + descuentoPickup : null, !promo && !descuentoPickup && esPickupEntrega ? 'Pasas por él a la cocina' : null].filter(Boolean).join('  ·  ') || 'Envío incluido en el precio'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-body)',
      fontWeight: 800,
      fontSize: 20,
    ...
    disabled: enviando,
    onClick: confirmar
  }, enviando ? /*#__PURE__*/React.createElement(PuntosEnviando, null) : `Confirmar · $${subtotal}`), motivo && /*#__PURE__*/React.createElement("p", {
    role: "alert",
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: 11,
  ...
  }, motivo === 'cerrado' ? 'La cocina está cerrada ahorita.' + (apertura.texto ? ' Abrimos ' + apertura.texto.toLowerCase() + '.' : '') : esPickupEntrega ? 'Falta elegir la forma de pago.' : 'Faltan datos: dirección dentro del radio y forma de pago.')), /*#__PURE__*/React.createElement(TabBar, {
    tab: tab,
    onTab: onTab,
    count: count
  }));
...
function AppTracking({
  ...
  }, d)))), orden && orden.estado === 'entregada' && typeof PideResena === 'function' && /*#__PURE__*/React.createElement(PideResena, {
    style: {
      marginTop: 22
    }
...
function AppMobile() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, content, /*#__PURE__*/React.createElement(PopupPromo, {
    abierto: promoAbierta,
